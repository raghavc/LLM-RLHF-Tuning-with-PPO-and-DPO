"""Pairwise reward-model training entry point."""

from trl import ModelConfig, RewardConfig, RewardTrainer, TrlParser, get_peft_config, get_quantization_config
...
def main() -> None:
    parser = TrlParser((DataArguments, RewardConfig, ModelConfig))
