"""Direct Preference Optimization entry point."""

from trl import DPOConfig, DPOTrainer, ModelConfig, TrlParser, get_peft_config, get_quantization_config
...
def main() -> None:
    parser = TrlParser((DataArguments, DPOConfig, ModelConfig))
